...
%---------------------------------------------------------
  \cventry
    {Software Engineer Apprentice} % Job title
    {ALX Africa} % Organization
    {} % Location
    {Aug. 2022 - Current} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {C Development, Data Structures, recursion Preprosessor file I/O, Static library, Creating Shell.}
        \item {Python Development, Data Structures and inheritance. Web-scrapping. Restful API's, Web-framework & Object Relational Mapping.}
        \item {HTML & CSS development}
        \item {C development with advanced data structures i.e. hash tables, binary trees and algoriths.}
        \item {Unix processes and signals, Regex, Networking.}
        \item {JavaScript Development, Web-Scrapping, SSH, SSL Certificates, Web Servers, Load Balancer, Firewall, Code Deployment, WebStack Debugging.}
      \end{cvitems}
    }
